...
<div class="h-dvh overflow-y-scroll flex justify-center w-full">
	<div
		id="background-img"
		...
		<div class="">
			...
			>
				...
				<p class="text-lg font-semibold">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam a dolorem quas officiis
					aperiam iure, ab accusamus, vero molestias odit vitae adipisci sint. Laborum in rerum
					doloremque aliquam sequi ducimus?
				</p>
			</div>
		</div>
	</div>
