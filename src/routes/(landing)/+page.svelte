		...
		<div class="relative background-img flex flex-col justify-center min-w-[367px] min-h-[511px]">
			...
			<div class="mx-10 z-50">
				<div class="mb-5">
					...
					<p class="maitree text-sm">กิจกรรมสายรหัสครั้งที่ 9 จัดขึ้นเพื่อส่งเสริมความสัมพันธ์อันดีระหว่างรุ่นพี่ รุ่นน้อง เพื่อให้สามารถช่วยเหลือซึ่งกันและกันทั้งในด้านการเรียนและด้านอื่นๆ โดยกิจกรรมจัดขึ้นในช่วงวันที่
				...
				<div class="mb-5">
					...
					<p class="maitree text-sm">นักศึกษาคณะเทคโนโลยีสารสนเทศ สจล. รุ่นที่ 21 และรุ่นที่ 22สามารถเข้าร่วมเป็นพี่รหัสพี่-น้องรหัสได้ ในส่วนของรุ่นพี่รุ่นอื่นสามารถเข้าร่วมกิจกรรมในฐานะ visitor</p>
				</div>
				<div class="mb-5">
					<div class="relative flex justify-center items-center mb-2">
					...
					<p class="maitree text-sm">นักศึกษาต้องทำการกรอกข้อมูลส่วนตัว อุปนิสัย ความชอบหลังจากเข้าสู่ระบบ จึงจะนับได้ว่าเข้าร่วมกิจกรรมโดยสมบูรณ์</p>
				</div>
